...
def write_text_report(
    ...
    lines.append("")
    network_skipped = sum(1 for report in reports if report.get("type") == "url" and not report.get("ok"))
    lines.append(f"Network checks skipped or reported unresolved: {network_skipped}")
